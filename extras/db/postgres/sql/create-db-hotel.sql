...
-- (5) 2. PowerShell:
--     docker compose exec db bash
--        psql --dbname=postgres --username=postgres --file=/sql/create-db-hotel.sql
--        psql --dbname=kunde --username=kunde --file=/sql/create-schema-hotel.sql
...
CREATE ROLE hotel LOGIN PASSWORD 'p';
...
CREATE TABLESPACE hotelspace OWNER hotel LOCATION '/var/lib/postgresql/tablespace/hotel';
