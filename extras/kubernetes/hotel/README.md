...
| datasource.url | string | `"jdbc:postgresql://localhost/hotel"` | URL für den DB-Zugriff |
| datasource.username | string | `"hotel"` | Benutzername für das DB-System |
...
| image.name | string | `"hotel"` | Name des Image |
