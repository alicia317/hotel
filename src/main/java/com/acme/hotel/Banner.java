...
final class Banner {
    ...
    private static final String FIGLET = """
        ...
        """;
    private static final String SERVICE_HOST = System.getenv("HOTEL_SERVICE_HOST");
    private static final String KUBERNETES = SERVICE_HOST == null
        ? "N/A"
        : STR."HOTEL_SERVICE_HOST=\{SERVICE_HOST}, HOTEL_SERVICE_PORT=\{System.getenv("HOTEL_SERVICE_PORT")}";
